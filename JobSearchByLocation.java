...
public class JobSearchByLocation extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * FROM jobs WHERE job_location LIKE ?");
            ...
            if (!found) out.print("<p style=\"color:#999; padding:20px;\">No jobs found in <b>" + location + "</b></p>");
